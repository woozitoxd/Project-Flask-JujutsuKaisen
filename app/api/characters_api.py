...
characters = [
    ...
    },
    {
        ...
        "image": "nobara.webp",
        "image_detail": "/static/img/nobara_detail.webp",
        "bio": [
...
def get_characters():
    # Creamos una copia de los datos con rutas completas
    characters_with_urls = []
    for character in characters:
        character_copy = character.copy()
        character_copy['image'] = url_for('static', filename=f"img/{character['image']}")
        character_copy['image_detail'] = url_for('static', filename=f"img/{character['image_detail']}")
        characters_with_urls.append(character_copy)

    return jsonify(characters_with_urls)